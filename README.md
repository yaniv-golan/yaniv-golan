I'm here because you can take the developer and turn him into a [VC](https://www.lool.vc/yaniv/), but you can't take the urge to code - at least once in a while - out of the developer 🤯
...
| [Airtable openAI Schema Generator](https://github.com/yaniv-golan/airtable-openapi-schema-generator) | Generates an OpenAPI 3.1.0 schema from your Airtable base — drop it straight into a Custom GPT as Actions |
...
| [Claude Code Telegram Plus](https://github.com/yaniv-golan/cc-telegram-plus) | Enhanced Telegram channel for Claude Code — all media types, voice transcription, session management, and more |
| [offlickr](https://github.com/yaniv-golan/offlickr) | Flickr export → static site |
...
| [Skill: Docsend to PDF](https://github.com/yaniv-golan/docsend-to-pdf-skill) | Save any DocSend link as a PDF, gates and all (email/passcode/NDA/verification) — Python CLI + cross-platform AI agent skill |
| [Skill: Papermark to PDF](https://github.com/yaniv-golan/papermark-to-pdf-skill) |  Save any Papermark deck as a PDF by intercepting the signed CloudFront slide images in a headless browser — the only approach that works around session-tied URLs and CORS |
...
| [dlzoom](https://github.com/yaniv-golan/dlzoom) | Download Zoom cloud recordings from the command line — M4A audio + STJ diarization JSON for custom transcription pipelines |
| [asr-bias-builder](https://github.com/yaniv-golan/asr-bias-builder) | Build ASR bias artifacts from PDF/PPTX decks — generates Whisper hotword prompts and Google Speech-to-Text phrase sets |
| [STJ](https://github.com/yaniv-golan/STJ) | Standard Transcription JSON — open format for structured transcription data with SRT/VTT support |
| [stjlib](https://github.com/yaniv-golan/stjlib) | Python library for reading, writing, and validating STJ transcription files |
| [Skill: Transcription Reader](https://github.com/yaniv-golan/transcription-reader-skill) | AI agent skill for reading SRT, VTT, STJ, and ASS subtitle files — strips timing metadata for 40–90% token savings |
| [Skill: Youtube Downloader](https://github.com/yaniv-golan/ytd-skill) | AI agent skill for downloading YouTube videos with interactive resolution and subtitle selection |
| [Skill: Control Smalltv Ultra](https://github.com/yaniv-golan/smalltv-ultra-skill) | Claude skill for controlling, customizing, and developing firmware for the GeekMagic SmallTV Ultra |
| [Skill: Pikud Haoref Alerts](https://github.com/yaniv-golan/pikud-haoref-alerts) | Claude Code plugin for Israel's Pikud HaOref alert system — rocket alerts, earthquake warnings, civil defense notifications |
| [Affinity API docs in markdowb](https://github.com/yaniv-golan/affinity-api-docs) | Affinity CRM API documentation as static Markdown — llms.txt index and offline access for AI coding assistants |
| [enex2notion](https://github.com/yaniv-golan/enex2notion) | Import Evernote ENEX files to Notion (Fixed fork) |
